...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border border-transparent shrink-0 w-fit whitespace-nowrap transition-colors focus:outline-none focus:ring-[3px] focus:ring-ring",
  {
    variants: {
      ...
      size: {
        sm: "h-lg px-2xs gap-3xs typo-paragraph-xs-semibold [&>svg]:size-sm",
        default: "h-xl px-xs gap-3xs typo-paragraph-xs-semibold [&>svg]:size-sm",
    ...
    compoundVariants: [
      ...
      { level: "secondary", size: "sm", className: "typo-paragraph-xs" },
      { level: "secondary", size: "default", className: "typo-paragraph-xs" },
...
const badgeRoundVariants = cva(
  "inline-flex items-center justify-center rounded-full shrink-0 transition-colors focus:outline-none focus:ring-[3px] focus:ring-ring",
  {
    variants: {
      ...
      size: {
        sm: "size-lg typo-paragraph-xs-semibold [&>svg]:size-sm",
        default: "size-xl typo-paragraph-xs-semibold [&>svg]:size-sm",
